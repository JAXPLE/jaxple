...
### 대원 C&C (2026.09 ~ 현재)
**SKTelecom 채널 서비스 개발팀**

### Astatine - Java 기반 게임 사설서버 운영 (2022. 12 ~ 현재)
**동시 접속자 20명 이상의 Java 기반 게임 사설 서버 운영 및 시스템 고도화**
...
### Wurst - Open Source Contribution (2023. 05 ~ 2026.01)
...
### 코스코스 파트너스 - TradingView-Telegram 연동 서버 (2025. 03 ~ 2025. 06)
**트레이딩뷰 신호를 텔레그램으로 전달하는 Event-Driven 기반 시세 알림 서버 설계 및 구현**
...
* **site:** [jaxple.dev](https://jaxple.dev)
