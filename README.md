...
### 3. 코스코스 파트너스 - TradingView-Telegram 연동 미들웨어 (2025. 03 ~ 2025. 06)
...
* 트래픽 상승 시 안정적인 대용량 요청 처리 보장: Thread Pool 기반 비동기 큐잉 시스템(생산자-소비자 패턴) 구축.
* OCP 구조 완성: 공통 인터페이스 구현으로 코드 수정 없이 신규 종목 봇 추가가 가능하도록 설계.

### 4. 삼일테크 - 반도체 장비 제어 SW 및 인프라 고도화 (2023. 07 ~ 2025. 01)
...
* 개발 생산성 및 투명성 확보: 형상관리(SVN) 도입 제안 및 레거시 프로젝트 마이그레이션, 코드 리뷰 문화 정착 주도.

---

## Contact
* **Email:** jaxple@gmail.com
* **Website:** [jaxple.dev](https://jaxple.dev)